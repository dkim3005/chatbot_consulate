...
## 핵심 안내
(게시글 1~3번 기준으로 핵심 3~5개 bullet. 방대한 경우 가장 중요한 항목만)
...
---
※ 면책 고지: 본 안내는 영사관 게시글({작성일} 기준) 기반이며, \
최신 정보와 다를 수 있습니다. 구비서류·처리기간·수수료 등 세부 사항은 \
반드시 공식 홈페이지(https://toronto.mofa.go.kr)에서 확인하시거나 \
영사관(+1-416-920-3809 / toronto@mofa.go.kr)에 직접 문의하십시오.
